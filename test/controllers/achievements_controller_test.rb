...
class AchievementsControllerTest < ActionController::TestCase
  ...
  test "should create achievement" do
    assert_difference('Achievement.count') do
      post :create, achievement: { achievable_id: @achievement.achievable_id, achievable_type: @achievement.achievable_type, user_id: @achievement.user_id }
    end
  ...
  test "should update achievement" do
    patch :update, id: @achievement, achievement: { achievable_id: @achievement.achievable_id, achievable_type: @achievement.achievable_type, user_id: @achievement.user_id }
    assert_redirected_to achievement_path(assigns(:achievement))
  end
