class AchievementsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @achievement.save
        if @achievement.achievable_type == "Lesson" && @achievement.achievable.next
          format.html { redirect_to lesson_path(@achievement.achievable.next), notice: 'Achievement was successfully created.' }
        else
          format.html { redirect_to course_path(@achievement.achievable.course), notice: 'Achievement was successfully created.' }
        end
  ...
  private
    ...
    def achievement_params
      params.require(:achievement).permit(:user_id, :achievable_type, :achievable_id)
    end
end
